...
- (id)initWithFrame:(CGRect)frame
{
    ...
    {
        self.releaseText = NSLocalizedString(@"Thả để cập nhật...", @"Release to load more status");
        self.pullUpText = NSLocalizedString(@"Kéo để cập nhật...", @"Pull down to load more status");
        self.loadingText = NSLocalizedString(@"Đang tải...", @"Loading Status");
