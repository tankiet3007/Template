...
- (id)initWithFrame:(CGRect)frame datePermanentStoreKey:(NSString *)datePermanentStoreKey
{
    ...
    {
        self.releaseText = NSLocalizedString(@"Thả để cập nhật...", @"Release to refresh status");
        self.pullDownText = NSLocalizedString(@"Kéo để cập nhật...", @"Pull down to refresh status");
