...
@interface SignUpTableViewController ()<IQActionSheetPickerViewDelegate>
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    if (indexPath.row == 0) {
        LoginCell *cell = (LoginCell *)[tableView dequeueReusableCellWithIdentifier:@"LoginCell"];
        if (cell == nil)
        {
    ...
    {
        InfomationCell *cell = (InfomationCell *)[tableView dequeueReusableCellWithIdentifier:@"InfomationCell"];
        if (cell == nil)
        {
